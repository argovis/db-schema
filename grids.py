...
# creates an empty collection in the argo db called <grid name> with schema validation enforcement and defined indexes
...
db[grid].create_index([("geolocation.coordinates", "2d"), ("timestamp", -1)])
